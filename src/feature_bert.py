...
class MultiModalBertModel(nn.Module):
    ...
    def __init__(self, bert_model_name, vector_input_size, num_classes):
        ...
        # self.mlp = nn.Sequential(
        #     nn.Linear(vector_input_size, 128),
        #     nn.LeakyReLU(0.2),
        #     nn.Dropout(0.5),
        #     nn.Linear(128, 64),
        #     nn.LeakyReLU(0.2)
...
class MultiModalBertModelMod(nn.Module):
    """
    bert_model_name - allegro/herbert-base-cased or dkleczek/bert-base-polish-uncased-v1
    """
    def __init__(self, bert_model_name, vector_input_size, num_classes):
        super(MultiModalBertModelMod, self).__init__()
        ...
        combined_features_size = bert_hidden_size + 64
...
class OnlyBert(nn.Module):
    ...
    def __init__(self, bert_model_name, vector_input_size, num_classes):
        ...
        combined_features_size = bert_hidden_size
